...
class DataTest {
    ...
    public void testMinPrice() {
        Data data = new Data("main.java.Data/testData.txt");
    ...
    public void testFilterData() {
        ...
        try {
            Data dataNull = new Data("main.java.Data/nullData.txt");
    ...
    public void testNullData() {
        assertThrows(IllegalArgumentException.class, () -> new Data("main.java.Data/nullData.txt"));
    }
}